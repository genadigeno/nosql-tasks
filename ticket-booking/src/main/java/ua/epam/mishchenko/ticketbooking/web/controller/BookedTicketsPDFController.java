...
public class BookedTicketsPDFController {
     ...
     */
    @GetMapping("/{userId}")
    public ResponseEntity<Object> getBookedTicketsByUserPDF(@PathVariable org.bson.types.ObjectId userId,
     ...
     */
    private User getUserById(org.bson.types.ObjectId userId) {
     ...
     */
    private List<Ticket> getBookedTickets(org.bson.types.ObjectId userId, int pageSize, int pageNum, User userById) {
