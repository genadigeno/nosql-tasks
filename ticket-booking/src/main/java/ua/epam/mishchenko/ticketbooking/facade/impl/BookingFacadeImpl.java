...
public class BookingFacadeImpl implements BookingFacade {
     ...
     */
    @Override
    public Event getEventById(org.bson.types.ObjectId eventId) {
     ...
     */
    @Override
    public User getUserById(org.bson.types.ObjectId userId) {
     ...
     */
    @Override
    public boolean deleteUser(org.bson.types.ObjectId userId) {
    ...
    public boolean cancelTicket(org.bson.types.ObjectId objectIdId) {
        return ticketService.cancelTicket(objectIdId);
    }
